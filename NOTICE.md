...
## 이용 조건
- **비영리** 목적의 개인 사용 및 무료 재배포를 허용합니다.
- 본 패치 또는 그 일부를 **판매하거나 유료로 제공하는 행위를 금지**합니다.
- 재배포 시 출처(본 저장소)를 표기해 주세요.

## 책임의 한계
- 본 패치는 "있는 그대로(as-is)" 제공되며, 사용으로 인한 어떠한 문제(세이브 손상, 충돌 등)에 대해서도 보증하지 않습니다.
- 적용 전 원본 파일 백업을 권장합니다.

## 권리자 요청
- 원저작권자가 배포 중단을 요청할 경우, 즉시 본 저장소의 관련 파일을 삭제합니다.
